...
**Where / when.** USS Cassini, holding 1,000 km off the Sending, matched, shields up. Stardate 39739.5. Ship's time 1839. Shakedown day 13. The light at 1900.

**Scene.** Observation lounge, 1839, rising. Picard (decided: light at 1900, bounded; the first words to the Sent are the XO's to draft; he hears them first). Vorrat (the scope signed; to engineering). Kask (kill switch at tactical at 1900). Data (to ops: the core's draw, the passenger channel). Lloyd: the words.

**Elsewhere.** Bridge: relief until 1900; Vint went to eat at 1830 on Picard's order. Sickbay: Prakash (will find Data after 1900). The Sending: the Eldest asking on its intervals; Ossane decided to ask the strangers for the number when the channel opens; Hollen's clock says 300.
...
**Next.** 1900: the light. The XO drafts the first words to the Sent. Standing down before 1900 costs nothing; after it, the Sent are on the channel.
