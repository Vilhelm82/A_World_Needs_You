...
**Where / when.** USS Cassini, holding 1,000 km off the Sending, matched, shields up; deflector on four collector panels at 0.4% since 1900, to ~1931. Stardate 39739.5. Ship's time 1907. Shakedown day 13.

**Scene.** Bridge, 1901. The number and the Hearth told. The Eldest closed the Sent's channel 0.8 s after the Hearth message; 'The Sent are tired.' The light still on (to ~1931). Kask: a breach; hand on the switch, not touching it. Picard: instinct to keep the light on; 'tell me why I'm wrong'. Data at ops (carrier down; the Eldest's carrier open). Kask at tactical (switch is hers). Vint at conn. Vorrat on comm (bus taking it, clean).

**Elsewhere.** The Sending: the Sent's channel closed by the Eldest; inside the model Ossane at the ark's instrument looking at the remnant, Hollen with her; the model at full on the Cassini's light. Sickbay: Prakash listening on the bridge feed. Astrometrics: ch'Rasseth listening.
...
**Lloyd carries.** Posting orders (chronicle/001). Shakedown itinerary (chronicle/002). The exchange log extract (chronicle/003). Rank Lt. Cmdr.; billet XO. Duffel on deck 8. Combadge.

**Telling.** Senses: second person, present; pull; nothing flagged. Recap: chronicle. Options off. Pace steady.

# Carry

**Next.** The words go. Thirty minutes of light. Not a place to stand down.
