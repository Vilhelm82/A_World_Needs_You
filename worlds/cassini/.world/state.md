...
**Where / when.** USS Cassini, holding 1,000 km off the Sending, matched, shields up. Stardate 39739.4. Ship's time 1728. Shakedown day 13. The number is in: 3,100 ± 100; home a remnant; the destination empty. Lloyd sent to eat; called at 1810.

**Scene.** Bridge, 1706. Picard in the chair (has the number, the remnant and the empty destination; 'nothing goes out'; sent the XO to eat). Lloyd at the XO's station. Data at ops (priced the trickle; said the 251 would be at hull temperature if aboard; has not said the rest). Kask at tactical (the deflector comes off at her word; criteria unmet). Vint at conn (holding matched). Viewscreen: the windows; the tenders. The band: the Eldest's carrier open; the Sent closed.

**Elsewhere.** Engineering: Vorrat characterising the ring's collectors until ~1813; 'or we could take it at its word'. Sickbay: Prakash (told 'children'; an embryo bank, she'd stake her licence; retracted 'a very long time'). Astrometrics: ch'Rasseth — done; antennae flat. The Sending: the Sent told nothing of 1703–05; Ossane at the windows; Hollen winding; the Eldest waiting for light.
