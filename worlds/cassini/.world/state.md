...
**Where / when.** USS Cassini, holding 1,000 km off the Sending, matched, shields up. Stardate 39739.4. Ship's time 1706. Shakedown day 13. Astrometrics' number due ~1726.

**Scene.** Bridge, 1706. Picard in the chair (four answers, one refusal; 'the fifth is the one that matters'; waiting for the number and the XO's next). Lloyd at the XO's station. Data at ops (said 1,212 = the cells; has not said what 961 is). Kask at tactical ('a different ship'; criteria unmet). Vint at conn (holding matched). Viewscreen: the windows; the tenders. The band: the Eldest's carrier open; the Sent closed.

**Elsewhere.** Engineering: Vorrat (a few more hours off the ark's reactor; converter unbuilt; report to write). Sickbay: Prakash (the bank; not yet told 'children'). Astrometrics: ch'Rasseth on the second digit. The Sending: the Sent told nothing of 1703–05; Ossane at the windows; Hollen winding; the Eldest waiting for light.
